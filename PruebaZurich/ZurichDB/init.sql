...
-- Tabla de Tipos de P�liza (cat�logo)
...
(
    ...
    UsuarioId INT NULL, -- Relaci�n con usuario si tiene acceso al sistema
...
-- 3. Se crean �ndices para mejorar el rendimiento
...
VALUES 
    ...
    ('Salud', 'Seguro m�dico y de salud'),
